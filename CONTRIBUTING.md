...
All development is done on ubuntu 18.04 LTS. Assuming you have just ubuntu fresh, this section will outline the steps to installing dependencies and tools required for development on the project.  
